...
from .models import CustomUser, Staffs, Courses, Subjects, Students, SessionYearModel, LeaveReportStaff, StudentResult
...
def staff_add_result(request):
	...
	for subject in subjects:
		print(subject)
	return render(request, "staff_template/staff_add_result_template.html", context)
