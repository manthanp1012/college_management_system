...
import datetime
from .models import Notice,CustomUser, Staffs, Courses, Subjects, Students, LeaveReportStudent, StudentResult
...
def student_view_leave(request):
	...
	return render(request, 'student_template/student_view_leave.html', context)
...
def student_view_notice(request):
    ...
    return render(request,'student_template/student_view_notice_template.html',context)